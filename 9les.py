...
# Ансамблиевы методы. В основе идея объединения нескольких переобученных моделей для уменьшения эффекта переобучения. Это назывется баггинг
...
# Достоинства
# - Простота и быстрота. Распаллеливание процесса и выигрыш во времени
# - Вероятностная классификация
# - Модель непараметрическая и хорошо работает с задачами, где другие модели могут оказаться неудобными

# Недостатки
# - Сложно интерпетировать
...
# Метод главных компонентов - алгоритм обучения без учителя.
# Часто используют для понижения размерности

# Задача машинного обучения без учителя состоит в выяснении зависимости медлу признаками
# Выполняется качественная оценка этой зависимости путем поиска главных осей координат и использования для описания набора данных
...
# - Простота инетрпритации и эффективность в работе с данными
