...
# print (np.full((4,5), 3.1415)) полно

# print (np.arange(0, 20, 2))

# print (np.eye(4)) 11111
...
# np.random.seed(1) какой то не рандомный рандом
...
# print(x1.ndim, x1.shape, x1.size)   ##ndim - число размерностей
# print(x2.ndim, x2.shape, x2.size)   ##shape - размер каждой размерности
# print(x3.ndim, x3.shape, x3.size)   ##size - общее число элементов
...
## Срез [s:f:step] по умолчанию [0:shape:1]

# a = np.array([1,2,3,4,5,6])

# print(a[:3:]) #или print(a[0:3:1])
# print(a[3:]) # индекс больше 2
# print(a[1:-1]) # средние индексы
# print(a[1:5]) # средние индексы
# print(a[1:6:2]) # с шагом 2
# print(a[1::2]) # с шагом 2
...
# print(np.concatenate([x,y,z])) объед

# x = np.array([1,2,3])
# y = np.array([4,5,6])

# rl = np.vstack([x,y]) горизонт
# print(rl)

# print(np.hstack([rl,rl])) верт
...
# Минус, унарный минус, деление, деление с округлением в меньшую сторону, возведение в стпепень, остаток от деления

## 12. Привести пример использования всех универсальных функций, которые я привел выше
...
# y = np.zeros(10)
# print(np.multiply(x,10, out=y[::2])) что то странное
...
# print(np.add.accumulate(x)) сложение прошлых

# x = np.arange(1,10)
# print(np.add.outer(x,x)) табл сложения
